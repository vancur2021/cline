...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		geminiAlwaysIncludeThoughts: config.geminiAlwaysIncludeThoughts,
		geminiUseThinkingTag: config.geminiUseThinkingTag,
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		// Global configuration fields
		geminiAlwaysIncludeThoughts: protoConfig.geminiAlwaysIncludeThoughts,
		geminiUseThinkingTag: protoConfig.geminiUseThinkingTag,
		...
		planModeOpenRouterModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.planModeOpenRouterModelInfo),
		...
		planModeRequestyModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.planModeRequestyModelInfo),
		...
		planModeGroqModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.planModeGroqModelInfo),
		planModeBasetenModelId: protoConfig.planModeBasetenModelId,
		planModeBasetenModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.planModeBasetenModelInfo),
		planModeHuggingFaceModelId: protoConfig.planModeHuggingFaceModelId,
		planModeHuggingFaceModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.planModeHuggingFaceModelInfo),
		...
		planModeHuaweiCloudMaasModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.planModeHuaweiCloudMaasModelInfo),
		...
		planModeHicapModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.planModeHicapModelInfo),
		...
		actModeOpenRouterModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.actModeOpenRouterModelInfo),
		...
		actModeRequestyModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.actModeRequestyModelInfo),
		...
		actModeGroqModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.actModeGroqModelInfo),
		actModeBasetenModelId: protoConfig.actModeBasetenModelId,
		actModeBasetenModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.actModeBasetenModelInfo),
		actModeHuggingFaceModelId: protoConfig.actModeHuggingFaceModelId,
		actModeHuggingFaceModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.actModeHuggingFaceModelInfo),
		...
		actModeHuaweiCloudMaasModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.actModeHuaweiCloudMaasModelInfo),
		...
		actModeHicapModelInfo: convertModelInfoToProtoOpenRouter(protoConfig.actModeHicapModelInfo),
