...
const getObjectiveTemplateText = (context: SystemPromptContext) => `You accomplish a given task iteratively, breaking it down into clear steps and working through them methodically.
